...
<body>
    <div class="container mt-4">
        ...
        <form id="lokasiForm">
            <div class="form-group">
                ...
                <input type="text" id="namaLokasi" name="namaLokasi" class="form-control" required>
            </div>
    ...
    <script>
        document.getElementById('lokasiForm').addEventListener('submit', function(event) {
            ...
            fetch('<?php echo site_url('lokasi/create'); ?>', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    if (data.status === 'error') {
                        ...
                        message.innerHTML = '<div class="alert alert-success">Lokasi berhasil ditambahkan!</div>';
                        if (confirm('Lokasi berhasil ditambahkan. Apakah Anda ingin kembali ke halaman sebelumnya?')) {
